...
public class UserDAO {
	...
	/**
	 *
	 * @param usernameField The username taken from the LoginForm
	 * @param passwordField The password taken from the LoginForm
	 */
	...
	/**
	 *
	 * @return Whether the user trying to log in has Administrator privileges 
	 */
