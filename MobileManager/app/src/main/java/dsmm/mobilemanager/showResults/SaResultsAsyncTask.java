 ...
 */
public class SaResultsAsyncTask extends AsyncTask<Void,Void,Boolean> {
    ...
    public SaResultsAsyncTask(AlertDialog.Builder dialog,Context context,final EditText input,String hash) {
        this.dialog=dialog;
    ...
    public Boolean doInBackground(Void... params){
        ...
        try {
            ...
            results = restTemplate.getForObject(url+"/"+hash, String.class);
                ...
                dialog.setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        if(no.length()!=0){
                            ...
                            res_dialog.setTitle("SA Results");
                            res_dialog.show();
                        }
                        else{
